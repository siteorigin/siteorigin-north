...
function siteorigin_north_panels_lite_localization( $loc ){
	return wp_parse_args(array(
		...
		'home_install_message' => __('SiteOrigin North supports Page Builder to create beautifully proportioned column based content.', 'siteorigin-north'),   // Longer message to display to a user about installing the plugin
